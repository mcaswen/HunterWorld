...
#include "HunterGameplayAbility_Interact.h"
...
#include "UI/IndicatorSystem/HunterIndicatorManagerComponent.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterGameplayAbility_Interact)
...
UHunterGameplayAbility_Interact::UHunterGameplayAbility_Interact(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	ActivationPolicy = EHunterAbilityActivationPolicy::OnSpawn;
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
	NetExecutionPolicy = EGameplayAbilityNetExecutionPolicy::LocalPredicted;
}

void UHunterGameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void UHunterGameplayAbility_Interact::UpdateInteractions(const TArray<FInteractionOption>& InteractiveOptions)
{
	if (AHunterPlayerController* PC = GetHunterPlayerControllerFromActorInfo())
	{
		if (UHunterIndicatorManagerComponent* IndicatorManager = UHunterIndicatorManagerComponent::GetComponent(PC))
		{
...
void UHunterGameplayAbility_Interact::TriggerInteraction()
{
