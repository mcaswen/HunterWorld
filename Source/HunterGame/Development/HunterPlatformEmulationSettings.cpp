...
#include "HunterPlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "HunterCheats"

UHunterPlatformEmulationSettings::UHunterPlatformEmulationSettings()
{
}

FName UHunterPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UHunterPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UHunterPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UHunterPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UHunterPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UHunterPlatformEmulationSettings::PostInitProperties()
{
...
void UHunterPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UHunterPlatformEmulationSettings::ApplySettings()
{
...
void UHunterPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UHunterPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UHunterPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UHunterPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
