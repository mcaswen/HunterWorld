...
#include "HunterPawnExtensionComponent.generated.h"
 ...
 */
UCLASS(MinimalAPI)
class UHunterPawnExtensionComponent : public UPawnComponent, public IGameFrameworkInitStateInterface
{
	GENERATED_BODY()

public:

	UE_API UHunterPawnExtensionComponent(const FObjectInitializer& ObjectInitializer);
	...
	static UHunterPawnExtensionComponent* FindPawnExtensionComponent(const AActor* Actor) { return (Actor ? Actor->FindComponentByClass<UHunterPawnExtensionComponent>() : nullptr); }
