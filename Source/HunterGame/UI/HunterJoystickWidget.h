...
#include "HunterJoystickWidget.generated.h"
...
/**
 *  A UMG wrapper for the Hunter virtual joystick.
 *
 ...
 */
UCLASS(MinimalAPI, meta=( DisplayName="Hunter Joystick" ))
class UHunterJoystickWidget : public UHunterSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UE_API UHunterJoystickWidget(const FObjectInitializer& ObjectInitializer);
