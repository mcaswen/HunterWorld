...
#include "HunterWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterWidgetFactory_Class)

TSubclassOf<UUserWidget> UHunterWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{
