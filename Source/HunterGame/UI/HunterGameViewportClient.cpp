...
#include "HunterGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterGameViewportClient)
...
UHunterGameViewportClient::UHunterGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UHunterGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
