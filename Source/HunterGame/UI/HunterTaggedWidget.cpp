...
#include "HunterTaggedWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterTaggedWidget)

//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

UHunterTaggedWidget::UHunterTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UHunterTaggedWidget::NativeConstruct()
{
...
void UHunterTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void UHunterTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void UHunterTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
