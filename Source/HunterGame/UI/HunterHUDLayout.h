...
#include "HunterHUDLayout.generated.h"

class UCommonActivatableWidget;
class UObject;
class UHunterControllerDisconnectedScreen;
 ...
 */
UCLASS(Abstract, BlueprintType, Blueprintable, Meta = (DisplayName = "Hunter HUD Layout", Category = "Hunter|HUD"))
class UHunterHUDLayout : public UHunterActivatableWidget
{
	GENERATED_BODY()

public:

	UHunterHUDLayout(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	*/
	...
	TSubclassOf<UHunterControllerDisconnectedScreen> ControllerDisconnectedScreen;
