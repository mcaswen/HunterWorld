...
#include "HunterTaggedWidget.generated.h"
...
class UHunterTaggedWidget : public UCommonUserWidget
{
	GENERATED_BODY()

public:
	UHunterTaggedWidget(const FObjectInitializer& ObjectInitializer);
