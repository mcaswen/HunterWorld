...
UHunterReticleWidgetBase::UHunterReticleWidgetBase(const FObjectInitializer& ObjectInitializer)
...
float UHunterReticleWidgetBase::ComputeMaxScreenspaceSpreadRadius() const
{
