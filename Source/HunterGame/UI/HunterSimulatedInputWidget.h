...
#include "HunterSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(MinimalAPI, meta=( DisplayName="Hunter Simulated Input Widget" ))
class UHunterSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UE_API UHunterSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
