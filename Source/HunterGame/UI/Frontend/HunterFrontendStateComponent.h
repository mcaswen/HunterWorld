...
#include "HunterFrontendStateComponent.generated.h"
...
UCLASS(Abstract)
class UHunterFrontendStateComponent : public UGameStateComponent, public ILoadingProcessInterface
{
	GENERATED_BODY()

public:

	UHunterFrontendStateComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
