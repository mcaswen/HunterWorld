...
#include "HunterControllerDisconnectedScreen.generated.h"
...
class UHunterControllerDisconnectedScreen : public UCommonActivatableWidget
{
	GENERATED_BODY()
public:
	UHunterControllerDisconnectedScreen(const FObjectInitializer& ObjectInitializer);
