...
#include "HunterPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "HunterCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UHunterCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UHunterCameraMode_ThirdPerson : public UHunterCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FHunterPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
