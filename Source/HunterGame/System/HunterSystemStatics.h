...
#include "HunterSystemStatics.generated.h"
...
UCLASS()
class UHunterSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="Hunter", meta = (WorldContext = "WorldContextObject"))
