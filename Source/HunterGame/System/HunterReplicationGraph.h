...
#include "HunterReplicationGraph.generated.h"

class AGameplayDebuggerCategoryReplicator;

DECLARE_LOG_CATEGORY_EXTERN(LogHunterRepGraph, Display, All);

/** Hunter Replication Graph implementation. See additional notes in HunterReplicationGraph.cpp! */
UCLASS(transient, config=Engine)
class UHunterReplicationGraph : public UReplicationGraph
{
	GENERATED_BODY()

public:
	UHunterReplicationGraph();
...
private:
	...
	/** Classes that had their replication settings explictly set by code in UHunterReplicationGraph::InitGlobalActorClassSettings */
	TArray<UClass*> ExplicitlySetClasses;
};

UCLASS()
class UHunterReplicationGraphNode_AlwaysRelevant_ForConnection : public UReplicationGraphNode_AlwaysRelevant_ForConnection
{
	GENERATED_BODY()
...
*/
UCLASS()
class UHunterReplicationGraphNode_PlayerStateFrequencyLimiter : public UReplicationGraphNode
{
	GENERATED_BODY()
