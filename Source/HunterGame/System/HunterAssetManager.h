...
#include "HunterAssetManagerStartupJob.h"
#include "Templates/SubclassOf.h"
#include "HunterAssetManager.generated.h"
...
class UHunterAssetManager : public UAssetManager
{
	GENERATED_BODY()

public:

	UE_API UHunterAssetManager();

	// Returns the AssetManager singleton object.
	static UE_API UHunterAssetManager& Get();
...
private:
	...
	TArray<FHunterAssetManagerStartupJob> StartupJobs;
...
template<typename AssetType>
AssetType* UHunterAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
...
template<typename AssetType>
TSubclassOf<AssetType> UHunterAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
