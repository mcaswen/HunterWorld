...
#include "HunterActorUtilities.h"

#include "GameFramework/Actor.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterActorUtilities)

EBlueprintExposedNetMode UHunterActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
