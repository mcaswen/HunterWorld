...
#include "HunterDevelopmentStatics.generated.h"
...
UCLASS()
class UHunterDevelopmentStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	// Should game logic skip directly to gameplay (skipping any match warmup / waiting for players / etc... aspects)
	// Will always return false except when playing in the editor and bTestFullGameFlowInPIE (in Hunter Developer Settings) is false
	...
	// Will always return true except when playing in the editor and bSkipLoadingCosmeticBackgroundsInPIE (in Hunter Developer Settings) is true
	UFUNCTION(BlueprintCallable, Category = "Hunter", meta=(ExpandBoolAsExecs="ReturnValue"))
