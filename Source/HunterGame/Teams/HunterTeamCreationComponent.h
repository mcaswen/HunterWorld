...
#include "HunterTeamCreationComponent.generated.h"
...
class UHunterTeamCreationComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	UHunterTeamCreationComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
