...
void ULyraTeamCreationComponent::ServerChooseTeamForPlayer(AHunterPlayerState* PS)
{
...
void ULyraTeamCreationComponent::ServerCreateTeam(int32 TeamId, UHunterTeamDisplayAsset* DisplayAsset)
{
	check(HasAuthority());
