...
#include "HunterSettingValueDiscrete_Language.generated.h"
...
UCLASS(MinimalAPI)
class UHunterSettingValueDiscrete_Language : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UE_API UHunterSettingValueDiscrete_Language();
