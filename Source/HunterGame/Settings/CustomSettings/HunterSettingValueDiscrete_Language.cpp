...
#include "HunterSettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterSettingValueDiscrete_Language)

#define LOCTEXT_NAMESPACE "Hunter"

static const int32 SettingSystemDefaultLanguageIndex = 0;

UHunterSettingValueDiscrete_Language::UHunterSettingValueDiscrete_Language()
{
}

void UHunterSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void UHunterSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void UHunterSettingValueDiscrete_Language::OnApply()
{
...
void UHunterSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void UHunterSettingValueDiscrete_Language::RestoreToInitial()
{
	if (UHunterSettingsShared* Settings = CastChecked<UHunterLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void UHunterSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (UHunterSettingsShared* Settings = CastChecked<UHunterLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 UHunterSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const UHunterSettingsShared* Settings = CastChecked<UHunterLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> UHunterSettingValueDiscrete_Language::GetDiscreteOptions() const
{
