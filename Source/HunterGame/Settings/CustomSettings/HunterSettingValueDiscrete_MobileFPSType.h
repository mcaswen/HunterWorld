...
//#include "Settings/HunterMobilePerformance.h"
#include "GameSettingValueDiscrete.h"

#include "HunterSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class UHunterSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UHunterSettingValueDiscrete_MobileFPSType();
