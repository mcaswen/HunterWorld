...
#include "HunterSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class UHunterSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~UHunterSettingValueDiscreteDynamic_AudioOutputDevice() = default;
