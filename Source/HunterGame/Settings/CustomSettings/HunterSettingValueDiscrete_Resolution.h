...
#include "HunterSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UHunterSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UHunterSettingValueDiscrete_Resolution();
