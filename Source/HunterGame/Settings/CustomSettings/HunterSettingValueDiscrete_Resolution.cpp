...
#include "HunterSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "HunterSettings"

UHunterSettingValueDiscrete_Resolution::UHunterSettingValueDiscrete_Resolution()
{
}

void UHunterSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UHunterSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UHunterSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UHunterSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UHunterSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UHunterSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UHunterSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UHunterSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UHunterSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UHunterSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UHunterSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UHunterSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UHunterSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UHunterSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UHunterSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UHunterSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
