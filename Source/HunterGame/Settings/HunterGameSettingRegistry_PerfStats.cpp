...
#include "CustomSettings/HunterSettingValueDiscrete_PerfStat.h"
...
static TAutoConsoleVariable<bool> CVarLatencyMarkersRequireNVIDIA(TEXT("Hunter.Settings.LatencyMarkersRequireNVIDIA"),
	true,
...
public:
	...
	{
		if (!UHunterSettingsLocal::DoesPlatformSupportLatencyTrackingStats())
		{
...
public:
	...
	virtual void GatherEditState(const ULocalPlayer * InLocalPlayer, FGameSettingEditableState & InOutEditState) const override
	{
		if (!UHunterSettingsLocal::DoesPlatformSupportLatencyMarkers())
		{
			InOutEditState.Disable(LOCTEXT("PlatformDoesNotSupportLatencyMarkers", "Latency markers are not supported on this device"));
		}

		// Hunter is only going to use the "Reflex" plugin to track these latency stats, so restrict these settings to NVIDIA devices. 
...
void UHunterGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, UHunterLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)EHunterDisplayablePerformanceStat::Count == 18, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::ClientFPS);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::ServerFPS);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::FrameTime);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::IdleTime);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::Ping);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::PacketSize_Outgoing);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				...
				Setting->SetDefaultValue(UHunterSettingsLocal::DoesPlatformSupportLatencyTrackingStats());
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::Latency_Total);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::Latency_Game);
			...
			{
				UHunterSettingValueDiscrete_PerfStat* Setting = NewObject<UHunterSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EHunterDisplayablePerformanceStat::Latency_Render);
