...
#include "HunterBrightnessEditor.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterBrightnessEditor)
...
UHunterBrightnessEditor::UHunterBrightnessEditor(const FObjectInitializer& Initializer)
	: Super(Initializer)
{
...
void UHunterBrightnessEditor::NativeOnInitialized()
{
	Super::NativeOnInitialized();
	Switcher_SafeZoneMessage->SetActiveWidget(RichText_Default);
}

void UHunterBrightnessEditor::NativeOnActivated()
{
...
bool UHunterBrightnessEditor::ExecuteActionForSetting_Implementation(FGameplayTag ActionTag, UGameSetting* InSetting)
{
...
FReply UHunterBrightnessEditor::NativeOnAnalogValueChanged(const FGeometry& InGeometry, const FAnalogInputEvent& InAnalogEvent)
{
...
FReply UHunterBrightnessEditor::NativeOnMouseWheel(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
...
void UHunterBrightnessEditor::HandleInputModeChanged(ECommonInputType InInputType)
{
...
void UHunterBrightnessEditor::HandleBackClicked()
{
	DeactivateWidget();
	SSafeZone::SetGlobalSafeZoneScale(UHunterSettingsLocal::Get()->GetSafeZone());
}

void UHunterBrightnessEditor::HandleDoneClicked()
{
