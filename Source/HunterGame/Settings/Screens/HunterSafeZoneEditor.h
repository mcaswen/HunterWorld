...
#include "HunterSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UHunterSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UHunterSafeZoneEditor(const FObjectInitializer& Initializer);
