...
#include "HunterSettingsListEntrySetting_KeyboardInput.generated.h"
...
class UHunterSettingKeyboardInput;
class UObject;

//////////////////////////////////////////////////////////////////////////
// UHunterSettingsListEntrySetting_KeyboardInput
//////////////////////////////////////////////////////////////////////////

UCLASS(Abstract, Blueprintable, meta = (Category = "Settings", DisableNativeTick))
class UHunterSettingsListEntrySetting_KeyboardInput : public UGameSettingListEntry_Setting
{
	GENERATED_BODY()
...
protected:
	UPROPERTY()
	TObjectPtr<UHunterSettingKeyboardInput> KeyboardInputSetting;
