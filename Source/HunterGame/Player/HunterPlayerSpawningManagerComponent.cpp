...
#include "HunterPlayerSpawningManagerComponent.h"
...
UHunterPlayerSpawningManagerComponent::UHunterPlayerSpawningManagerComponent(const FObjectInitializer& ObjectInitializer)
...
void UHunterPlayerSpawningManagerComponent::InitializeComponent()
{
...
void UHunterPlayerSpawningManagerComponent::OnLevelAdded(ULevel* InLevel, UWorld* InWorld)
{
	if (InWorld == GetWorld())
	{
...
// AHunterGameMode Proxied Calls - Need to handle when someone chooses
// to restart a player the normal way in the engine.
//======================================================================

AActor* UHunterPlayerSpawningManagerComponent::ChoosePlayerStart(AController* Player)
{
	if (Player)
	{
#if WITH_EDITOR
...
#if WITH_EDITOR
APlayerStart* UHunterPlayerSpawningManagerComponent::FindPlayFromHereStart(AController* Player)
{
...
bool UHunterPlayerSpawningManagerComponent::ControllerCanRestart(AController* Player)
{
...
void UHunterPlayerSpawningManagerComponent::FinishRestartPlayer(AController* NewPlayer, const FRotator& StartRotation)
{
...
void UHunterPlayerSpawningManagerComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
