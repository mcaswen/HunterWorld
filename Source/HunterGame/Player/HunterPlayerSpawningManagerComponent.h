...
#include "HunterPlayerSpawningManagerComponent.generated.h"
...
/**
 * @class UHunterPlayerSpawningManagerComponent
 */
UCLASS(MinimalAPI)
class UHunterPlayerSpawningManagerComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	UE_API UHunterPlayerSpawningManagerComponent(const FObjectInitializer& ObjectInitializer);
...
private:
	...
	/** We proxy these calls from AHunterGameMode, to this component so that each experience can more easily customize the respawn system they want. */
