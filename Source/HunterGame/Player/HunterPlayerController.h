...
#include "Camera/HunterCameraAssistInterface.h"
...
class AHunterPlayerController : public ACommonPlayerController, public IHunterCameraAssistInterface, public IHunterTeamAgentInterface
{
	GENERATED_BODY()

public:

	UE_API AHunterPlayerController(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	//~IHunterCameraAssistInterface interface
	UE_API virtual void OnCameraPenetratingTarget() override;
	//~End of IHunterCameraAssistInterface interface
...
protected:
	...
	UE_API void OnSettingsChanged(UHunterSettingsShared* Settings);
...
UCLASS()
class AHunterReplayPlayerController : public AHunterPlayerController
{
	GENERATED_BODY()
