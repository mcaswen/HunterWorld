...
#include "HunterRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UHunterRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UHunterRangedWeaponInstance : public UHunterWeaponInstance, public IHunterAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UHunterRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~UHunterEquipmentInstance interface
	virtual void OnEquipped();
	virtual void OnUnequipped();
	//~End of UHunterEquipmentInstance interface

	void AddSpread();

	//~IHunterAbilitySourceInterface interface
	...
	//~End of IHunterAbilitySourceInterface interface
