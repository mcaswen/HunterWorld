...
#include "HunterWeaponSpawner.generated.h"
...
class UHunterWeaponPickupDefinition;
class UObject;
...
class AHunterWeaponSpawner : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	UE_API AHunterWeaponSpawner();
...
protected:
	...
	UPROPERTY(EditInstanceOnly, BlueprintReadOnly, Category = "Hunter|WeaponPickup")
	TObjectPtr<UHunterWeaponPickupDefinition> WeaponDefinition;

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, ReplicatedUsing = OnRep_WeaponAvailability, Category = "Hunter|WeaponPickup")
	bool bIsWeaponAvailable;

	//The amount of time between weapon pickup and weapon spawning in seconds
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Hunter|WeaponPickup")
	float CoolDownTime;
	...
	UPROPERTY(BlueprintReadOnly, Transient, Category = "Hunter|WeaponPickup")
...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "Hunter|WeaponPickup")
	TObjectPtr<UStaticMeshComponent> WeaponMesh;

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Hunter|WeaponPickup")
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "Hunter|WeaponPickup")
	UE_API bool GiveWeapon(TSubclassOf<UHunterInventoryItemDefinition> WeaponItemClass, APawn* ReceivingPawn);

	UE_API void StartCoolDown();

	UFUNCTION(BlueprintCallable, Category = "Hunter|WeaponPickup")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "Hunter|WeaponPickup")
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Hunter|WeaponPickup")
	static UE_API int32 GetDefaultStatFromItemDef(const TSubclassOf<UHunterInventoryItemDefinition> WeaponItemClass, FGameplayTag StatTag);
};
