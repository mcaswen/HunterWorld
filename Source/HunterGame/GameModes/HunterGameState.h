...
class AHunterGameState : public AModularGameStateBase, public IAbilitySystemInterface
{
	GENERATED_BODY()

public:

	UE_API AHunterGameState(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
private:
	...
	UPROPERTY()
	TObjectPtr<UHunterExperienceManagerComponent> ExperienceManagerComponent;
