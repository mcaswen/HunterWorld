 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnHunterGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class AHunterGameMode : public AModularGameModeBase
{
	GENERATED_BODY()
...
public:
	...
	FOnHunterGameModePlayerInitialized OnGameModePlayerInitialized;
