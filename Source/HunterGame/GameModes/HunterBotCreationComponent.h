...
#include "HunterBotCreationComponent.generated.h"
...
class UHunterBotCreationComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	UHunterBotCreationComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
