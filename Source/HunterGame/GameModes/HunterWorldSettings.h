...
#include "HunterWorldSettings.generated.h"
 ...
 */
UCLASS(MinimalAPI)
class AHunterWorldSettings : public AWorldSettings
{
	GENERATED_BODY()

public:

	UE_API AHunterWorldSettings(const FObjectInitializer& ObjectInitializer);
