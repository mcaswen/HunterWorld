...
#include "HunterCharacterPartTypes.generated.h"
...
struct FHunterCharacterPartHandle
{
	GENERATED_BODY()
...
struct FHunterCharacterPart
{
	...
	static bool AreEquivalentParts(const FHunterCharacterPart& A, const FHunterCharacterPart& B)
	{
