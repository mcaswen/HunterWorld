...
#include "HunterCosmeticAnimationTypes.generated.h"
...
struct FHunterAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FHunterAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FHunterAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FHunterAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FHunterAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FHunterAnimBodyStyleSelectionEntry> MeshRules;
