...
#define LOCTEXT_NAMESPACE "HunterGameFeatures"
...
{
	for (const FHunterHUDElementEntry& Entry : Widgets)
	{
...
void UGameFeatureAction_AddWidgets::AddToWorld(const FWorldContext& WorldContext, const FGameFeatureStateChangeContext& ChangeContext)
{
	...
	if ((GameInstance != nullptr) && (World != nullptr) && World->IsGameWorld())
	{
		...
		{			
			TSoftClassPtr<AActor> HUDActorClass = AHunterHUD::StaticClass();
...
{
	AHunterHUD* HUD = CastChecked<AHunterHUD>(Actor);
