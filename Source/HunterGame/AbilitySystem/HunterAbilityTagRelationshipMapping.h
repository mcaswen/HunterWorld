...
#include "HunterAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FHunterAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UHunterAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FHunterAbilityTagRelationship> AbilityTagRelationships;
