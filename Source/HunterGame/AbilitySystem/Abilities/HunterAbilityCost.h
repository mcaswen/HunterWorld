...
#include "HunterAbilityCost.generated.h"
 ...
 * UHunterAbilityCost
 *
 * Base class for costs that a HunterGameplayAbility has (e.g., ammo or charges)
 */
UCLASS(MinimalAPI, DefaultToInstanced, EditInlineNew, Abstract)
class UHunterAbilityCost : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	virtual bool CheckCost(const UHunterGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, FGameplayTagContainer* OptionalRelevantTags) const
	{
		return true;
	}
	 ...
	 */
	virtual void ApplyCost(const UHunterGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
	{
	}
