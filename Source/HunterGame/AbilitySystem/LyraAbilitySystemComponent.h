...
public:
	...
	typedef TFunctionRef<bool(const ULyraGameplayAbility* HunterAbility, FGameplayAbilitySpecHandle Handle)> TShouldCancelAbilityFunc;
	...
	UE_API void AddAbilityToActivationGroup(EHunterAbilityActivationGroup Group, ULyraGameplayAbility* HunterAbility);
	UE_API void RemoveAbilityFromActivationGroup(EHunterAbilityActivationGroup Group, ULyraGameplayAbility* HunterAbility);
	UE_API void CancelActivationGroupAbilities(EHunterAbilityActivationGroup Group, ULyraGameplayAbility* IgnoreHunterAbility, bool bReplicateCancelAbility);
