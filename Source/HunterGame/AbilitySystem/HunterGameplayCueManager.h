...
#include "HunterGameplayCueManager.generated.h"
...
/**
 * UHunterGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UHunterGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UHunterGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UHunterGameplayCueManager* Get();
