...
#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterHotfixManager)

int32 UHunterHotfixManager::GameHotfixCounter = 0;

UHunterHotfixManager::UHunterHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &UHunterHotfixManager::GetOnScreenMessages);
...
void UHunterHotfixManager::Init()
{
	Super::Init();
}

void UHunterHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		UHunterSettingsLocal* GameSettings = UHunterSettingsLocal::Get();
...
bool UHunterHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UHunterHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool UHunterHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UHunterHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void UHunterHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void UHunterHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
#if !UE_BUILD_SHIPPING
void UHunterHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void UHunterHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void UHunterHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
