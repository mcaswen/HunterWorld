...
#include "HunterTextHotfixConfig.generated.h"
...
class UHunterTextHotfixConfig : public UDeveloperSettings
{
	GENERATED_BODY()

public:
	UHunterTextHotfixConfig(const FObjectInitializer& ObjectInitializer);
