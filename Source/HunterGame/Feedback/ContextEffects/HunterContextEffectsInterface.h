...
#include "HunterContextEffectsInterface.generated.h"
 ...
 */
 ...
 class UHunterContextEffectsInterface : public UInterface
 {
	 GENERATED_BODY()

 };
 
 class IHunterContextEffectsInterface : public IInterface
 {
	 GENERATED_BODY()
