...
#include "HunterNumberPopComponent_MeshText.h"

#include "Components/StaticMeshComponent.h"
#include "Engine/CollisionProfile.h"
#include "Engine/Engine.h"
#include "Engine/World.h"
#include "Feedback/NumberPops/HunterNumberPopComponent.h"
#include "HunterDamagePopStyle.h"
#include "Materials/MaterialInstanceDynamic.h"
#include "TimerManager.h"
#include "UObject/Package.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterNumberPopComponent_MeshText)

class UStaticMesh;

UHunterNumberPopComponent_MeshText::UHunterNumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void UHunterNumberPopComponent_MeshText::AddNumberPop(const FHunterNumberPopRequest& NewRequest)
{
...
void UHunterNumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor UHunterNumberPopComponent_MeshText::DetermineColor(const FHunterNumberPopRequest& Request) const
{
	for (UHunterDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* UHunterNumberPopComponent_MeshText::DetermineStaticMesh(const FHunterNumberPopRequest& Request) const
{
	for (UHunterDamagePopStyle* Style : Styles)
	{
...
void UHunterNumberPopComponent_MeshText::SetMaterialParameters(const FHunterNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
