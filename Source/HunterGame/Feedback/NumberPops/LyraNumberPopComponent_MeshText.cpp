...
void ULyraNumberPopComponent_MeshText::AddNumberPop(const FHunterNumberPopRequest& NewRequest)
{
...
FLinearColor ULyraNumberPopComponent_MeshText::DetermineColor(const FHunterNumberPopRequest& Request) const
{
...
UStaticMesh* ULyraNumberPopComponent_MeshText::DetermineStaticMesh(const FHunterNumberPopRequest& Request) const
{
	for (UHunterDamagePopStyle* Style : Styles)
	{
...
void ULyraNumberPopComponent_MeshText::SetMaterialParameters(const FHunterNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
