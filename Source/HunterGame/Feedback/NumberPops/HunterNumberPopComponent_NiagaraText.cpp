...
#include "HunterNumberPopComponent_NiagaraText.h"

#include "Feedback/NumberPops/HunterNumberPopComponent.h"
#include "HunterDamagePopStyleNiagara.h"
#include "HunterLogChannels.h"
#include "NiagaraComponent.h"
#include "NiagaraDataInterfaceArrayFunctionLibrary.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterNumberPopComponent_NiagaraText)

UHunterNumberPopComponent_NiagaraText::UHunterNumberPopComponent_NiagaraText(const FObjectInitializer& ObjectInitializer)
...
void UHunterNumberPopComponent_NiagaraText::AddNumberPop(const FHunterNumberPopRequest& NewRequest)
{
	...
	UE_LOG(LogHunter, Log, TEXT("DamageHit location : %s"), *(NewRequest.WorldLocation.ToString()));
