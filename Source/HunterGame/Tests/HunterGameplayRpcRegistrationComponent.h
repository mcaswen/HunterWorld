...
#include "HunterGameplayRpcRegistrationComponent.generated.h"

#define UE_API HUNTERGAME_API


UCLASS(MinimalAPI)
class UHunterGameplayRpcRegistrationComponent : public UExternalRpcRegistrationComponent
{
	GENERATED_BODY()
protected:
	static UE_API UHunterGameplayRpcRegistrationComponent* ObjectInstance;

public:
	static UE_API UHunterGameplayRpcRegistrationComponent* GetInstance();
