...
class UHunterReplayList;
class UObject;
struct FEnumerateStreamsResult;
struct FFrame;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FQueryReplayAsyncDelegate, UHunterReplayList*, Results);
...
private:
	UPROPERTY()
	TObjectPtr<UHunterReplayList> ResultList;
