...
#include "HunterInputModifiers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(HunterInputModifiers)

DEFINE_LOG_CATEGORY_STATIC(LogHunterInputModifiers, Log, All);

//////////////////////////////////////////////////////////////////////
// HunterInputModifiersHelpers

namespace HunterInputModifiersHelpers
{
	/** Returns the owning HunterLocalPlayer of an Enhanced Player Input pointer */
	static UHunterLocalPlayer* GetLocalPlayer(const UEnhancedPlayerInput* PlayerInput)
	{
		if (PlayerInput)
		{
			if (APlayerController* PC = Cast<APlayerController>(PlayerInput->GetOuter()))
			{
				return Cast<UHunterLocalPlayer>(PC->GetLocalPlayer());
			}
		}
		return nullptr;
	}
...
//////////////////////////////////////////////////////////////////////
// UHunterSettingBasedScalar

FInputActionValue UHunterSettingBasedScalar::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	{
		if (UHunterLocalPlayer* LocalPlayer = HunterInputModifiersHelpers::GetLocalPlayer(PlayerInput))
		{
			const UClass* SettingsClass = UHunterSettingsShared::StaticClass();
			UHunterSettingsShared* SharedSettings = LocalPlayer->GetSharedSettings();
...
//////////////////////////////////////////////////////////////////////
// UHunterInputModifierDeadZone

FInputActionValue UHunterInputModifierDeadZone::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	EInputActionValueType ValueType = CurrentValue.GetValueType();
	UHunterLocalPlayer* LocalPlayer = HunterInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (ValueType == EInputActionValueType::Boolean || !LocalPlayer)
	{
		return CurrentValue;
	}
	
	UHunterSettingsShared* Settings = LocalPlayer->GetSharedSettings();
	ensure(Settings);
...
FLinearColor UHunterInputModifierDeadZone::GetVisualizationColor_Implementation(FInputActionValue SampleValue, FInputActionValue FinalValue) const
{
...
//////////////////////////////////////////////////////////////////////
// UHunterInputModifierGamepadSensitivity

FInputActionValue UHunterInputModifierGamepadSensitivity::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	const EHunterGamepadSensitivity Sensitivity = (TargetingType == EHunterTargetingType::Normal) ? Settings->GetGamepadLookSensitivityPreset() : Settings->GetGamepadTargetingSensitivityPreset();
...
//////////////////////////////////////////////////////////////////////
// UHunterInputModifierAimInversion

FInputActionValue UHunterInputModifierAimInversion::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	UHunterLocalPlayer* LocalPlayer = HunterInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (!LocalPlayer)
	{
