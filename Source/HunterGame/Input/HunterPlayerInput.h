...
#include "HunterPlayerInput.generated.h"

/**
 * Custom player input class for Hunter. This extends the functionality of Enhanced Input to also include
...
class UHunterPlayerInput : public UEnhancedPlayerInput
{
	GENERATED_BODY()

public:
	UHunterPlayerInput();
	virtual ~UHunterPlayerInput() override;
