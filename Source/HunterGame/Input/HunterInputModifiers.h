...
#include "HunterInputModifiers.generated.h"
...
class UHunterSettingBasedScalar : public UInputModifier
{
	GENERATED_BODY()
...
/**
 * This is a deadzone input modifier that will have it's thresholds driven by what is in the Hunter Shared game settings. 
 */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "Hunter Settings Driven Dead Zone"))
class UHunterInputModifierDeadZone : public UInputModifier
{
	GENERATED_BODY()
...
UENUM()
enum class EHunterTargetingType : uint8
{
...
/** Applies a scalar modifier based on the current gamepad settings in Hunter Shared game settings.  */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "Hunter Gamepad Sensitivity"))
class UHunterInputModifierGamepadSensitivity : public UInputModifier
{
	GENERATED_BODY()
public:
	...
	TObjectPtr<const UHunterAimSensitivityData> SensitivityLevelTable;

protected:
	virtual FInputActionValue ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime) override;
};

/** Applies an inversion of axis values based on a setting in the Hunter Shared game settings */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "Hunter Aim Inversion Setting"))
class UHunterInputModifierAimInversion : public UInputModifier
{
	GENERATED_BODY()
