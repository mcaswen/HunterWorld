...
#include "HunterInputUserSettings.generated.h"

#define UE_API HUNTERGAME_API

/** 
 * Custom settings class for any input related settings for the Hunter game.
 * This will be serialized out at the same time as the Hunter Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS(MinimalAPI)
class UHunterInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS(MinimalAPI)
class UHunterPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
