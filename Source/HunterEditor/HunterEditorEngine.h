...
#include "HunterEditorEngine.generated.h"
...
UCLASS()
class UHunterEditorEngine : public UUnrealEdEngine
{
	GENERATED_BODY()

public:

	UHunterEditorEngine(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
